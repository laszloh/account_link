...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_LINK_EXPLAIN'	=> 'Verknüpft Benutzerkonten so, dass Du leicht zwischen ihnen wechseln kannst, ohne Dich abmelden zu müssen.',
	...
	'ACCOUNT_SWITCH_REDIRECT'		=> 'Du hast Dich erfolgreich als %s angemeldet.',
	'LINKED_ACCOUNT_CREATED'		=> 'Das Benutzerkonto \'%1$s\' wurde erstellt und mit \'%2$s\' verknüpft.',
	'LINKED_GROUP_JOINED'			=> 'Du bist erfolgereich der/den folgenden Gruppe(n) beigetreten: %s.',
	'LINKED_GROUP_JOINED_PENDING'	=> 'Du hast erfolgreich Mitgliedschaft für die folgende(n) Gruppe(n) beantragt: %s. Bitte warte bis die Gruppenleiterung Deine Mitgliedschaft bestätigt.',
	...
	'ACCOUNT_SWITCH_ERROR'	=> 'Ein Fehler ist beim wechseln der Benutzerkonten aufgetreten. Du könntest abgemeldet sein.',
	'NOT_MASTER'			=> 'Dieses Benutzerkonto ist mit einem anderen verknüpft. Bitte wechsle zum Hauptkonto (%s), um die Benutzerkontenverknüpfung zu verwalten.',
	'NEW_INFO_REQUIRED'		=> 'Neuer Benutzername und Passwort sind notwendig.',
	
	'CREATE_LINKED_ACCOUNT' => 'Erstelle ein verknüpftes Benutzerkonto.',
